...
export default function UserCreateModal({ isOpen, onClose, onSuccess, onError }) {
    ...
    const validateForm = () => {
        ...
        if (!formData.plainPassword) errors.plainPassword = 'Password is required';
        else if (formData.plainPassword.length < 8) errors.plainPassword = 'Password must be at least 8 characters';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormData({ firstName: '', lastName: '', email: '', plainPassword: '', role: 0 });
            setValidationErrors({});
            onSuccess();
        } catch (error) {
                        ...
                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    />
                                    {validationErrors.plainPassword && <p className="mt-1 text-sm text-red-600">{validationErrors.plainPassword}</p>}
                                </div>
                                <div>
